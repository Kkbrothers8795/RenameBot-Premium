...
DB_NAME = "rename-pro-railway"
DB_URL = "mongodb+srv://user:user@cluster0.0vi8sg6.mongodb.net"
...
def insert(chat_id):
            user_id = int(chat_id)
            user_det = {"_id":user_id,"file_id":None ,"caption":None ,"daily":0 ,"date":0 , "uploadlimit" :5147483648,"used_limit":0,"usertype":"Free","prexdate" : None}
            try:
